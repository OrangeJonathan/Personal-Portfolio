<template>
    <div>
        ...
        <a href="https://github.com/OrangeJonathan" class="gitHub">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
        ...
        <a href="https://orangeplayah.itch.io/" class="itchIO">
            <svg 
                xmlns="http://www.w3.org/2000/svg" 
                height="24" 
                width="24" 
        ...
        <a href="mailto:info@jonathankat.nl" class="eMail">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
...
a.gitHub:link, a.gitHub:visited {
    color: #bebebe; /* White or very light gray */
}
a.gitHub:hover {
...
a.itchIO:link, a.itchIO:visited {
    color: #bebebe; /* White or very light gray */
}

a.itchIO:hover {
    color: #fa5c5c; /* GitHub purple */
}

a.itchIO svg {
    stroke-width: 7; /* Adjust this value to match visually */
}


a.linkedIn, a.gitHub, a.eMail, a.itchIO {
